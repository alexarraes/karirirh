			...
			<div class="row">
				<div class="col-md-12">
					<%
						...
						List<HistoricoSetor> hSetores = (List<HistoricoSetor>) request
								.getAttribute("hSetor");
						List<HistoricoSalario> hSalarios = (List<HistoricoSalario>) request
								.getAttribute("hSalarios");
						List<Dependente> deps = (List<Dependente>) request
								.getAttribute("dependente");
						List<Telefone> tels = (List<Telefone>) request
								.getAttribute("telefone");
						List<Ferias> ferias = (List<Ferias>) request.getAttribute("ferias");
						List<HistoricoAfastamento> hAfastamento = (List<HistoricoAfastamento>) request
								.getAttribute("hAfastamento");
						List<MedidaDisciplinar> mD = (List<MedidaDisciplinar>) request
								.getAttribute("mD");
					%>
					<%
						String fixo = null;
					...
					<p align="justify">
						...
						<%=" " + col.getNome() + " "%>
						dentro da nossa organização empresarial, por meio do:
						<ul>
						<li> Histórico de férias, que referencia o período em que o colaborador
						encontra-se em pausa do seu trabalho ou encontrou-se;</li>
						<li> Histórico
						de cargos, refere-se a alterações de funções;</li>
						<li> Histórico de salários, que informa alterações salariais;</li>
						<li> Histórico de
						afastamento onde compõem informações caso seja afastado e motivos
						do afastamento;</li>
						<li> Registro de medidas disciplinar, onde é
						informado medidas registradas: advertências verbais, escritas ou
						suspenção.</li>
						</ul>
				...
				<div class="col-md-12">
					<ul class="list-group">
						...
						<li class="list-group-item"><b>Cargo:</b><%=col.getCargo().getNome()%>&nbsp;
							...
							&nbsp; <b>Tempo Total na Empresa:</b><%=(col.isStatus()) ? (new Date().getDate() - col
					.getDataAdm().getDate())
					: (col.getDataDem().getDate() - col.getDataAdm().getDate())%> &nbsp;dia(s)</li>
						<li class="list-group-item"><b>Tipo de Contrato:</b><%=col.getContrato()%>&nbsp;
							<b>Data de Admissão:</b><%=new SimpleDateFormat("dd 'de' MMMM 'de' yyyy").format(col
					.getDataAdm())%> <b>Data de Demissão:</b><%=col.getDataDem()%>
							&nbsp;</li>
				...
				<div class="col-md-12">
					<table class="table">
						...
						.format(h.getDataInicio())%></td>
								<td><%=(h.getDataFim() != null) ? new SimpleDateFormat(
						"dd 'de' MMMM 'de' yyyy").format(h.getDataFim())
						: "Não possui"%></td>
							</tr>
							<%
								}
					...
					<div class="row">
						<div class="col-md-12">
							<div class="well">
								...
								<p>
									<b>Nome:</b>
									<%=m.getColaborador().getNome()%></p>
								<p>
									<b>Matrícula:</b>
									<%=m.getColaborador().getMatricula()%></p>
								<p>
									<b>Data:</b><%=m.getData()%></p>
								<p class="text-center">
									<b>Motivo:</b>
									<%=m.getMotivo()%></p>
							</div>
