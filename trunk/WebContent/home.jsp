...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 class="text-center text-success">Bem Vindo ao KaririRH</h1>
				<p class="lead text-center text-muted">Sistema para Gestão de
					Rotina do Recursos Humanos.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-4">
				...
				<p class="text-left">Consulte todos os setores ou serviços da
			...
			<div class="col-md-4">
				...
				<p class="text-left">Verifique cada cargo da empresa, e quais
					colaboradores vinculados a eles.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-4">
				...
				<p class="text-left">Cadastre um novo colaborador, adicione
			...
			<div class="col-md-4 text-center">
				...
				<p class="text-left">Consulte o histórico de cada colaborador,
					analise toda sua trajetória na empresa até o momento.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-4">
				...
				<p class="text-left">Registre ação orientativa, punitiva,
			...
			<div class="col-md-4 text-center">
				...
				<p class="text-left">Configure informações relacionada a
					empresa.</p>
			</div>
		</div>
	</div>
