...
<body>
	...
	<form name="BuscarSetor" action="SetorControlador" method="get">
		<fieldset>
			<input type="hidden" name="acao" value="buscarAlterar">
			<!-- Form Name -->
			<div class="container">
				<div class="row">
					<div class="col-md-12">
...
<%
	...
	%>
								<div class="form-group" draggable="true">
									<label for="BuscarSetor">Nome do Setor:*</label>
									<div>
					...
					href="SetorControlador?acao=listarTodos"><span>Listar Todos</span></a>
